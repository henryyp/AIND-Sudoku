...
class TestNakedTwins(unittest.TestCase):
    ...
    before_naked_twins_4 = {"G7": "2345678", "G6": "1236789", "G5": "23456789", "G4": "345678",
                            "G3": "1234569", "G2": "12345678", "G1": "23456789", "G9": "24578",
                            "G8": "345678", "C9": "124578", "C8": "3456789", "C3": "1234569",
                            "C2": "1234568", "C1": "2345689", "C7": "2345678", "C6": "236789",
                            "C5": "23456789", "C4": "345678", "E5": "678", "E4": "2", "F1": "1",
    ...
    def test_naked_twins(self):
        print('BEFORE NAKED: ')
        solution.display(self.before_naked_twins_4)
        print('\n CALUTATED NAKED: ')
        solution.display(solution.naked_twins(self.before_naked_twins_4))
        # print('\n AFTER NAKED: ')
